# DHI-STRICT-SOLUTIONS-WACA - The Open Source WhatsApp Business Solution

## Shape project future with Your Feedback
Help us improve our open-source "DHI-STRICT-SOLUTIONS-WACA" project! Share your thoughts and suggestions in our community discussion: [Click here](https://github.com/DRdarwin/DHI-STRICT-SOLUTIONS-WACA/discussions/3)
...
### Vercel setup
- [Deploy to vercel](https://vercel.com/new/git/external?repository-url=https://github.com/DRdarwin/DHI-STRICT-SOLUTIONS-WACA/&project-name=receevi&repository-name=DHI_STRICT_WHATSAPP_PORTAL)
...
- Clone this repository in your Computer
    - `git clone https://github.com/DRdarwin/DHI-STRICT-SOLUTIONS-WACA.git`
